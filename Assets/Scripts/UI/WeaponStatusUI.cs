...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("在子WeaponImage游戏对象上填充图像组件")]
    #endregion Tooltip
    [SerializeField] private Image weaponImage;
    #region Tooltip
    [Tooltip("从子AmmoHolder游戏对象填充变换")]
    #endregion Tooltip
    [SerializeField] private Transform ammoHolderTransform;
    #region Tooltip
    [Tooltip("在子ReloadText游戏对象上填充TextMeshPro Text组件")]
    #endregion Tooltip
    [SerializeField] private TextMeshProUGUI reloadText;
    #region Tooltip
    [Tooltip("在子AmmoRemainingText游戏对象上填充TextMeshPro Text组件")]
    #endregion Tooltip
    [SerializeField] private TextMeshProUGUI ammoRemainingText;
    #region Tooltip
    [Tooltip("在子WeaponNameText游戏对象上填充TextMeshPro Text组件")]
    #endregion Tooltip
    [SerializeField] private TextMeshProUGUI weaponNameText;
    #region Tooltip
    [Tooltip("使用子游戏对象ReloadBar的RectTransform填充")]
    #endregion Tooltip
    [SerializeField] private Transform reloadBar;
    #region Tooltip
    [Tooltip("在此填充子游戏对象BarImage的Image组件")]
    #endregion Tooltip
