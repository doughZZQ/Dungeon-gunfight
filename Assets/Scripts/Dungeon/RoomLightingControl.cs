...
public class RoomLightingControl : MonoBehaviour
{
    ...
    private IEnumerator FadeInRoomLightingRoutine(InstantiatedRoom instantiatedRoom)
    {
        ...
        instantiatedRoom.groundTilemap.GetComponent<TilemapRenderer>().material = variableLitMaterial;
        instantiatedRoom.decoration1Tilemap.GetComponent<TilemapRenderer>().material = variableLitMaterial;
        instantiatedRoom.decoration2Tilemap.GetComponent<TilemapRenderer>().material = variableLitMaterial;
        instantiatedRoom.frontTilemap.GetComponent<TilemapRenderer>().material = variableLitMaterial;
        instantiatedRoom.minimapTilemap.GetComponent<TilemapRenderer>().material = variableLitMaterial;
    ...
    private void FadeInDoors()
    {
        ...
        {
            DoorLightingControl doorLightingControl_ = door.GetComponentInChildren<DoorLightingControl>();

            doorLightingControl_.FadeInDoor(door);
        }
    }
}
