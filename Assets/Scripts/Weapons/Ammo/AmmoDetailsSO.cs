...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #endregion
    public float ammoRange = 20f; //弹药射程
    #region Tooltip
    [Tooltip("The rotation speed in degrees per second of the ammo pattern")]
    #endregion
    public float ammoRotationSpeed = 1f; //弹药旋转速度
    ...
    #endregion
    public float ammoSpreadMin = 0f; //弹药精确度最小值
    #region Tooltip
    ...
    #endregion
    public float ammoSpreadMax = 0f; //弹药精确度最大值
    ...
    #endregion
    public float ammoSpawnIntervalMin = 0f; //弹药生成间隔最小值
    #region Tooltip
    ...
    #endregion
    public float ammoSpawnIntervalMax = 0f; //弹药生成间隔最大值
    ...
    #endregion
    public Material ammoTrailMaterial; //弹药轨迹材质
    #region Tooltip
    [Tooltip("The starting width for the ammo trail.")]
    #endregion
    [Range(0f, 1f)] public float ammoTrailStartWidth; //弹药轨迹起始宽度
    #region Tooltip
    [Tooltip("The ending width for the ammo trail")]
    #endregion
    [Range(0f, 1f)] public float ammoTrailEndWidth; //弹药轨迹末尾宽度
